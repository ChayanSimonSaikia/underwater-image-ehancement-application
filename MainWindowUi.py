...
################################################################################
## Form generated from reading UI file 'v3cvcByH.ui'
##
...
"color: rgb(224, 224, 224);")
        ...
        self.gridLayoutWidget.setGeometry(QRect(10, 10, 30, 411))
...
"color: rgb(28, 28, 28);")
        icon5 = QIcon()
        icon5.addFile(u"../Image_editor/Icons/compress-solid.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.resizeBtn.setIcon(icon5)
...
"color: rgb(28, 28, 28);")
        icon6 = QIcon()
        icon6.addFile(u"../Image_editor/Icons/rotate-right-solid.svg", QSize(), QIcon.Normal, QIcon.Off)
